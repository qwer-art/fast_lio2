...
Pre-processed ROS2 bag files can be downloaded from [Dropbox](https://www.dropbox.com/scl/fo/i56kucdzxpzq1mr5jula7/ALJpdqvOZT1hTaQXEePCvyI?rlkey=y5bvslyazf09erko7gl0aylll&e=1&dl=0).

Available datasets:
- `colosseo_train0` - VBR Colosseum scene
- `10_14_acl_jackal`, `10_14_hathor` - MIT Campus (Kimera-Multi dataset)
